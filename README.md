...
<p align="center">
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-155_passing-3FCF8E">
</p>
...
> Whisper STT와 ffmpeg 번인은 별도 GPU 워커에서 동작합니다. 번인 카라오케는 whisperX 단어 타이밍이 있을 때 활성화되며, 없으면 평문으로 렌더됩니다.
