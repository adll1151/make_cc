...
<p align="center">
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-178_passing-3FCF8E">
...
| 큐 | BullMQ + Redis |
| STT | self-host Whisper large-v3 (ko) + pyannote 화자 분리 — 별도 GPU 워커 |
...
- [ ] first-party 분석 (Supabase 기반)
- [ ] 편집기 자막 스타일 AI 어시 — 영상 분석 → 추천 툴팁
...
| 버전 | 날짜 | 핵심 |
|------|------|------|
| **번역 (phase3)** | 2026-06-24 | 자막 다국어 번역 — DeepL 백엔드 · 편집기 번역 패널 · 번인 다국어 (prod 배포) |
